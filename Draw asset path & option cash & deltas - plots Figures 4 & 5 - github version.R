...
matplot(cbind(X[RunNo,1:N], Y[RunNo,1:N], Thomas_cash_account[RunNo,1:N]    ,   Thomas_delta_bought_put_by_FD[RunNo, 1:N] , 
                           b,0,1,b_trailing[RunNo,1:N],pmax(1,B_running_max[RunNo,1:N]), 
...
text(4/52*N ,b-0.04,"fixed barrier", cex=0.6, col="chocolate4")
...
#text(4/52*N ,1.15,"    Green is OLD Y_t", cex=0.6, col= "green4")
...
if(barrier_type == "fixed"){
  text(4/52*N , Thomas_delta_bought_put_by_FD[4/52*N]-0.23,"   analytic delta", cex=1.0, col="blue")
  }
